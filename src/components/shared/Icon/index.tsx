...
export const Search = ({ height = 24, width = 24, ...props }) => {
  return (
    <svg
      {...props}
      aria-label="Search"
...
export const Post = ({ height = 12, width = 12, ...props }) => {
  return (
    <svg
      {...props}
      aria-label=""
...
export const Share = ({ height = 24, width = 24, ...props }) => {
  return (
    <svg
      {...props}
      aria-label="Share"
...
export const Bookmark = ({ height = 24, width = 24, ...props }) => {
  return (
    <svg
      {...props}
      aria-label="Save"
